...
type CreateCountryRequest struct {
	...
	Creator int64  `protobuf:"varint,4,opt,name=creator,proto3" json:"creator,omitempty"` // 创建者
}
...
func (x *CreateCountryRequest) GetCreator() int64 {
	if x != nil {
		return x.Creator
	}
	return 0
...
type CountryData struct {
	...
	Creator         int64         `protobuf:"varint,7,opt,name=creator,proto3" json:"creator,omitempty"`                     // 国王
	...
	Grain           int64         `protobuf:"varint,17,opt,name=grain,proto3" json:"grain,omitempty"`                        // 粮食
	Copper          int64         `protobuf:"varint,18,opt,name=copper,proto3" json:"copper,omitempty"`                      // 铜钱
...
func (x *CountryData) GetCreator() int64 {
	if x != nil {
		return x.Creator
	}
	return 0
...
func (x *CountryData) GetGrain() int64 {
	if x != nil {
		return x.Grain
	}
	return 0
...
func (x *CountryData) GetCopper() int64 {
	if x != nil {
		return x.Copper
	}
	return 0
...
var file_country_v1_country_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f,
	...
	0x03, 0x52, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x20, 0x0a, 0x0b, 0x6d, 0x65,
	...
	0x01, 0x28, 0x03, 0x52, 0x05, 0x67, 0x72, 0x61, 0x69, 0x6e, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x6f,
	0x70, 0x70, 0x65, 0x72, 0x18, 0x12, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x63, 0x6f, 0x70, 0x70,
